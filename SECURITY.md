...
You may **report a vulnerability in two ways**:

1. **Use Github's private vulnerability reporting system**. Start a new report [here](https://github.com/knitli/.github/security/advisories/new) or in the equivalent reporting system for the affected product (i.e. https://github.com/knitli/codeweaver/security/advisories/new for CodeWeaver). With this method you may also optionally submit a private pull request with a fix for the vulnerability. Learn more [in the GitHub docs](https://docs.github.com/en/code-security/how-tos/report-and-fix-vulnerabilities/privately-reporting-a-security-vulnerability).

2. **Send a PGP-encrypted email** to adam@knitli.com. You can find our public PGP key [here](https://knitli.com/.well-known/pgp-key.txt).
...
(And no, we don't offer bounties. I'm a solo dev bootstrapping a startup; money is scarce. You'll have my deepest appreciation.)
